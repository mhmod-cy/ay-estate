...
export const Hero = (props: Props) => {
	return (
		<Container className="grid grid-cols-1 items-center gap-[85px] lg:grid-cols-2 py-[50px] lg:pt-[30px] lg:pb-[70px]">
			<div>
				<h1 className="text-[56px] font-[700] text-center lg:text-start leading-[1]">
					Discover Your Dream Home Today
				</h1>
				<p className="mt-[40px] leading-[22px] text-center lg:text-start">
				...
				<div className="mt-[64px] flex items-center gap-[16px] justify-center lg:justify-start">
					<Button className="font-[600]">Explore Now</Button>
					<Button variant="black" className="bg-transparent text-black hover:text-white border border-black font-[600] lg:font-normal">
						Learn more
					</Button>
				</div>
			</div>
